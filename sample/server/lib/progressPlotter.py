...
from server.lib.plotUtils3d import specify_axes, specify_layout, plot_all_sim_paths, plot_all_flights, plot_all_nodes, plot_all_nodes_sim


def make_progress_plot(geo_info, sim_info, flights, created_nodes, created_nodes_sim):
    ...
    data = sim_paths + flight_paths + node_scatter_plot + node_scatter_plot_sim
